...
from src.simulator import PhysicsEngine, Quaternion, SolarSystem, Spacecraft, Vector3D
...
class TestModelIntegration:
    ...
    def test_user_mission_integration(self):
        ...
        # Complete mission
        obj = Objective(
            id="obj1", description="Reach Mars", type="reach", target_id="mars"
        )
